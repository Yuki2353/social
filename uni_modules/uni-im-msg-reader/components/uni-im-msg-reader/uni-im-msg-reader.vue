<template>
  <view v-if="!msg.is_revoke" :class="{'self':currentUid == msg.from_uid}" class="uni-im-msg-reader">
    <text
...
export default {
  ...
  mounted() {
    this.conversation = uniIm.conversation.getCached(this.msg.conversation_id)
  },
  methods: {
    clickHandler() {
      if(this.isGroupMsg){
