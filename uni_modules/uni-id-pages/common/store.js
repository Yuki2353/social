...
// import uniCloud from '../../../common/js/unicloud';
		...
		if (data) {
			...
			try {
				...
				let res = await usersTable.where("'_id' == $cloudEnv_uid")
					.field('mobile,nickname,username,email,avatar,avatar_file,gender,isAdmin,introduction,backgroundImg')
					.get()
