...
async function postRegister (params = {}) {
  ...
  user.dcloud_appid = [appId]
	...
	// 自定义内容
	user.nickname = shortid.generate()
	user.avatar = "https://mp-7bce0be5-cd6d-45c3-8aef-5b6216eb2880.cdn.bspapp.com/default/default.png";
	user.avatar_file = {
		extname: user.avatar.split('.')[user.avatar.split('.').length - 1],
		name: user.avatar,
		url: user.avatar
	}
	user.gender = -1
